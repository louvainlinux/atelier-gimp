	...
	\begin{frame}{Enlever un élément de l'image}
		...
		\begin{figure}[H]
			...
			\begin{minipage}{.5\textwidth}
				...
				\caption{\tiny{Apollo 15 Lunar Module Pilot James Irwin salutes the U.S. flag.}}
			\end{minipage}%
			\begin{minipage}{.5\textwidth}
				\centering
...
\section{Filtres}
	...
	\begin{frame}{Filtres}
		...
		\begin{figure}[H]
			...
			\begin{minipage}{.5\textwidth}
				\centering
				\includegraphics[height=150px]{Images/filters/astronaut1} 
				\caption{Sans filtre appliqué}
			\end{minipage}%
			\begin{minipage}{.5\textwidth}
				\centering
				\includegraphics[height=150px]{Images/filters/astronaut2} 
