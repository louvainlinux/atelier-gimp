...
\logo{\includegraphics[height=5mm]{Images/logo_12-13-mini.png}}
...
\begin{figure}
	...
	\begin{tikzpicture}[scale=0.7, transform shape]
        \node[anchor=south west,inner sep=0] at (0.4,0) {\includegraphics[width=0.1\textwidth]{Images/gimp_couleurs_actives.png}};
	...
	\onslide<3>{\draw[red,ultra thick,rounded corners] (0.6,0) rectangle (1.55,0.7);
    	...
    	\end{tikzpicture} 
	%\includegraphics[width=0.1\textwidth]{Images/gimp_couleurs_actives.png}
\end{figure}
...
\begin{figure}
	...
	\begin{tikzpicture}[scale=1, transform shape]
        \node[anchor=south west,inner sep=0] at (0.4,0) {\includegraphics[width=0.4\textwidth]{Images/gimp_color_box.png}};
